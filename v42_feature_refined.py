...
output_price_path = os.path.join(output_dir, 'v42_refined_price.csv')
output_power_path = os.path.join(output_dir, 'v42_refined_output.csv')
...
if __name__ == '__main__':
    logger.info("=" * 60)
    logger.info("v42 精细特征工程版 - 多级滞后 + 偏差分布特征")
    logger.info("=" * 60)
