"""
v25 回退版 - 坚守v21 GBDT架构 + 稳健策略框架
回退原因: HistGradientBoosting收益低于v21 GBDT
保留: 稳健策略框架(noise_margin决策逻辑)
"""
import pandas as pd
import numpy as np
import os
...
output_price_path = os.path.join(output_dir, 'v25_gbdt_robust_price.csv')
output_power_path = os.path.join(output_dir, 'v25_gbdt_robust_output.csv')
...
if __name__ == '__main__':
    ...
    # 特征重要性
    print("\n" + "=" * 60)
    print("Feature Importance (v25 GBDT)")
    print("=" * 60)
