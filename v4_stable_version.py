...
if __name__ == '__main__':
    ...
    base_features = feature_cols + ['dayofweek', 'month_sin', 'month_cos']  # month 用周期性编码避免分布偏移
    ...
    generate_strategy(output_price_path, output_power_path, min_profit_threshold=500, use_robust=False)  # 使用贪婪策略 + 阈值保护
