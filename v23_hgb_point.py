"""
v23 终极突破版 - HistGradientBoosting + 逐点递推 + 多阶滞后
核心升级:
1. 引入 HistGradientBoostingRegressor (sklearn内置，类似LightGBM)
...
output_price_path = os.path.join(output_dir, 'v23_hgb_point_price.csv')
output_power_path = os.path.join(output_dir, 'v23_hgb_point_output.csv')
...
if __name__ == '__main__':
    print("=" * 60)
    print("v23 突破版 - HistGradientBoosting + 逐点递推多滞后")
    print("=" * 60)
